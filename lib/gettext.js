...
(function (root, undef) {
  ...
  var i18n = function (options) {
    ...
    var
      ...
      _plural_form = options.plural_form || defaults.plural_form;
      ...
      var t = function (messages, n /* ,extra */) {
        ...
        if (!_plural_func) {
          if (!pf_re.test(_plural_form))
            throw new Error(strfmt('The plural form "%1" is not valid', _plural_form));
          ...
          _plural_func = new Function("n", 'var plural, nplurals; '+ _plural_form +' return { nplural: nplurals, plural: (plural === true ? 1 : (plural ? plural : 0)) };');
        }
    ...
    return {
      ...
      setMessages: function (domain, locale, messages, plural_form) {
